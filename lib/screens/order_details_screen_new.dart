    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.receipt_long, color: Color(0xFF4285F4), size: 24),
              SizedBox(width: 12),
              Text(
                'Order Summary',
                style: TextStyle(
            ...
            child: item.imageUrl != null && item.imageUrl!.isNotEmpty
                ? ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: ApiService.getImageUrl(item.imageUrl),
                      fit: BoxFit.cover,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.payment, color: Color(0xFF4285F4), size: 24),
              SizedBox(width: 12),
              Text(
                'Payment Information',
                style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.timeline, color: Color(0xFF4285F4), size: 24),
              SizedBox(width: 12),
              Text(
                'Order Tracking',
                style: TextStyle(
          ...
          Column(
            children: [
              Container(
                ...
                height: 12,
                decoration: BoxDecoration(
                  color: isLatest ? Color(0xFF4285F4) : Colors.grey[400],
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 14,
                      color: isLatest ? Color(0xFF4285F4) : Colors.black87,
                    ),
                  ),
                  SizedBox(height: 4),
                  Text(
